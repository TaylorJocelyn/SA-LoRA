...
if __name__ == '__main__':
    ...
    ckpt = torch.load('reproduce/ldmi/weight/quantw4a4_20steps_efficientdm.pth')
    ...
    image_to_save.save('reproduce/ldm/sample/sample_100step_intsaved_w.jpg')
