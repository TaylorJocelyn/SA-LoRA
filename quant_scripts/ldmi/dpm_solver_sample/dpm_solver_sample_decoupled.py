...
if __name__ == '__main__':
    ...
    sampler = DpmSolverSampler(model, algorithm_type='dpmsolver', device=device)
    ...
    image_to_save.save("reproduce/ldmi/sample/dpm_solver++_{}steps_scale{}.png".format(sample_steps, scale))
