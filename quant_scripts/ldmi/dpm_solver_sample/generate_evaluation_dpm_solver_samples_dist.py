...
def main():
    ...
    os.makedirs('evaluate_data/scale{}_steps{}'.format(scale, sample_steps), exist_ok=True)
    ...
    out_path = os.path.join('evaluate_data/scale{}_steps{}'.format(scale, sample_steps), f"{args.quant_type}_{args.num_samples}_steps{sample_steps}_scale{scale}_1.npz")
