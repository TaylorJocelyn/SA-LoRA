...
from quant_scripts.quant_dataset import DiffusionInputDataset, get_calibration_set, get_train_samples
...
def main():
    ...
    if args.quant_type != 'fp32':
        ...
        ckpt = torch.load('reproduce/ldm/weight/quantw4a4_100steps_efficientdm_sample50.pth')
